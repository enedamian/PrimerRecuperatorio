...
# 1) implementar una funcion hashRecuperatorio(stringNombre, stringFecha) que recibe un nombre y una fecha de nacimiento y devuelve un numero 
# entero que representa el hash de la persona. stringFecha debe tener el formato "dd-mm-aaaa". 
...
# Luego, si la suma es par se le suma el DNI, sino se le suma el Legajo. 
